...
!(function() {
    ...
    (t.jqPaginator = function(e, a) {
        ...
        return (
            ...
            (r.init = function() {
                (a.first || a.prev || a.next || a.last || a.page) &&
                    (a = t.extend(
                        {},
            ...
            (r.verify = function() {
                ...
                if (
                    (t.totalCounts &&
                        t.pageSize &&
                        (t.totalPages = Math.ceil(t.totalCounts / t.pageSize)),
            ...
            (r.renderHtml = function() {
                for (
                    var e = [], a = r.getPages(), n = 0, i = a.length;
                    n < i;
                    n++
                )
                    e.push(r.buildItem("page", a[n]));
                r.isEnable("prev") &&
                    e.unshift(r.buildItem("prev", r.options.currentPage - 1)),
                    r.isEnable("first") && e.unshift(r.buildItem("first", 1)),
                    r.isEnable("statistics") &&
                        e.unshift(r.buildItem("statistics")),
                    r.isEnable("next") &&
                        e.push(r.buildItem("next", r.options.currentPage + 1)),
                    r.isEnable("last") &&
                        e.push(r.buildItem("last", r.options.totalPages)),
                    r.options.wrapper
                        ? r.$container.html(
                              t(r.options.wrapper)
                                  .html(e.join(""))
                        ...
                        : r.$container.html(e.join(""));
            }),
            (r.buildItem = function(e, a) {
                var n = r.options[e]
                    .replace(/{{page}}/g, a)
                    .replace(/{{totalPages}}/g, r.options.totalPages)
                    .replace(/{{totalCounts}}/g, r.options.totalCounts);
                return t(n)
                    .attr({ "jp-role": e, "jp-data": a })
                    .jqPaginatorHTML();
            }),
            (r.setStatus = function() {
                var e = r.options;
                (r.isEnable("first") && 1 !== e.currentPage) ||
                    t("[jp-role=first]", r.$container).addClass(e.disableClass),
                    (r.isEnable("prev") && 1 !== e.currentPage) ||
                        t("[jp-role=prev]", r.$container).addClass(
                            e.disableClass
                        ),
                    (!r.isEnable("next") || e.currentPage >= e.totalPages) &&
                        t("[jp-role=next]", r.$container).addClass(
                            e.disableClass
                        ),
                    (!r.isEnable("last") || e.currentPage >= e.totalPages) &&
                        t("[jp-role=last]", r.$container).addClass(
                            e.disableClass
                        ),
                    t("[jp-role=page]", r.$container).removeClass(
                        e.activeClass
                    ),
                    t(
                        "[jp-role=page][jp-data=" + e.currentPage + "]",
                        r.$container
            ...
            (r.fireEvent = function(t, e) {
                return (
                    "function" != typeof r.options.onPageChange ||
                    !1 !== r.options.onPageChange(t, e)
                );
            }),
            (r.callMethod = function(e, a) {
                switch (e) {
                    ...
                    default:
                        throw new Error(
                            '[jqPaginator] method "' + e + '" does not exist'
                        );
                }
                return r.$container;
            }),
        ...
        (t.fn.jqPaginator = function() {
            ...
            if ("string" == typeof e[0]) {
                ...
                throw new Error(
                    "[jqPaginator] the element is not instantiated"
                );
            }
